...
element.sh is a simple Bash script designed to take as input either an atomic number, atomic symbol or element name and return a statement of the input element's properties via a query of the periodic_table database. It is recommended you check the code as the PSQL variable will require establishing a username and password permissions for the postgreSQL queries.
